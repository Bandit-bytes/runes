...
public class StealthRune extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("item.runes_of_power.stealth_rune.tooltip")
                .withStyle(ChatFormatting.DARK_GRAY));
        tooltip.add(Component.translatable("item.runes_of_power.stealth_rune.lore")
        ...
        tooltip.add(Component.translatable("item.runes_of_power.stealth_rune.upgrade_hint")
